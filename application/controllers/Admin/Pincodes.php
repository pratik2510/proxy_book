...
class Pincodes extends CI_Controller {
    ...
    public function manage(){
        ...
        $this->form_validation->set_rules('name_field', 'Pincode Name', 'trim|required', array('required' => 'Please enter pincode name.'));
        
        if ($this->form_validation->run() == TRUE) {
            
            $pincode_name = $this->input->post('name_field');
        ...
        $this->template->load('admin', 'Admin/Pincodes/manage_pincodes', $this->data);
    }
}